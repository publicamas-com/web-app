...
const navigation = {
  ...
  help: [
    { name: 'Comprar', href: '#' },
    { name: 'Vender', href: '#' },
    { name: 'Resolucion de problemas', href: '#' },
    { name: 'Centro de seguridad', href: '#' },
  ],
  company: [
    { name: 'Sobre nosotros', href: '#' },
    { name: 'Trabaja con nosotros', href: '#' },
    { name: 'Programa de usuarios', href: '#' },
    { name: 'Blog', href: '#' },
  ],
  legal: [
    { name: 'Terminos y condiciones', href: '#' },
    { name: 'Como cuidamos tu privacidad', href: '#' },
    { name: 'Libro de quejas online', href: '#' },
  ],
  social: [
    {
      name: 'Facebook',
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm/6 font-semibold text-gray-900">Mi cuenta</h3>
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm/6 font-semibold text-gray-900">Ayuda</h3>
                <ul role="list" className="mt-6 space-y-4">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm/6 font-semibold text-gray-900">Publicamas</h3>
                <ul role="list" className="mt-6 space-y-4">
          ...
          <div className="mt-10 xl:mt-0">
            <h3 className="text-sm/6 font-semibold text-gray-900">Suscribete a las novedades de publicamas</h3>
            <p className="mt-2 text-sm/6 text-gray-600">
              Informacion, tendencias, nuevos productos y novedades sobre la plataforma.
            </p>
